...
namespace Mi_primer_API.Repository
{
    public class CategoryRepository : ICategoryRepository
    {
        ...
        {
            var category = await GetCategoryAsync(id);//Consulto que si exista
        ...
        {
            return await _context.Categories.AsNoTracking().FirstOrDefaultAsync(c => c.Id == id);//Lambda expessions
